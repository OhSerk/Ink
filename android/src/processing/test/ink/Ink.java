...
//nomeGiocatore[],   tastiera[] = {"Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "A", "S", "D", "F", "G", "H", "J", "K", "L", "Z", "X", "C", "V", "B", "N", "M"};
...
public void text(String a, float x, float y, float ts, int fil, int i) {
  ...
  if (mouseY >= (y-ts*1.5f)*height/640 && mouseY <= (y+ts/2)*height/640) { 
    ...
    if (scene.equals(parola[1]) && a.equals(parola[31])) {
      ...
      if (rel && (scene.equals(parola[1]) || scene.equals(parola[31]) || scene.equals("Linguaggiamelo"))) {
        nondevi = false;
